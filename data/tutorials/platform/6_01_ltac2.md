...
Ltac2 comes with a [core library](https://github.com/rocq-prover/rocq/tree/master/theories/Ltac2)
that exposes many .ml function of Rocq's code base to manipulate goals, terms, etc.,
like unification
...
- <a href="https://github.com/rocq-prover/platform-docs/issues/92" style="color:red">Introduction to Ltac2 for Newcommers</a>
- Ltac2 for Ltac1 Users 
  [interactive version](https://rocq-prover.org/platform-docs/metaprogramming/ltac2/tutorial_ltac2_for_ltac1_users.html) and
  [source code](https://rocq-prover.org/platform-docs/metaprogramming/ltac2/tutorial_ltac2_for_ltac1_users.v)
