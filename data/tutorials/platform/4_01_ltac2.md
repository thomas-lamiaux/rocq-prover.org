...
Ltac2 is a meta-programming language design to write reliable and predictable proof script.
It is the replacement for Ltac1 which had an unclear semantics, lacked expressivity, and was slow and error-prone.
...
- Effects to manipulate to the proof state, backtracking and terms
- It has a nice foreign-function interface to expose .ml code in Ltac2
